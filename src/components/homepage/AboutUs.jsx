...
const AboutUs = () => {
  ...
  const array = [
    {
      id: 1,
      text: "We understand the pain of manual invoicing and the hassle of keeping track of payments. That's why we created Invoice Genearator. Our mission is to simplify the invoicing process for businesses of all sizes, allowing them to focus on what they do best.",
      icon: FaTools,
    },
    {
      id: 2,
